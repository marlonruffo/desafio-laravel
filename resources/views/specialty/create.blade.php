...
<form action="" method="POST" class="w-full max-w-lg">
  ...
  <div class="grid gap-6 mb-6 md:grid-cols-2">
      <div>
          <label for="nome" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nome da especialidade</label>
      ...
      <div>
          <label for="valor" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Valor em R$</label>
