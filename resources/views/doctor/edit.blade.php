...
<form action="" method="POST" class="grid gap-6 mb-6 md:grid-cols-2">
    ...
    <div>
        <label for="periodo_trabalho" class="block mb-2 text-sm font-medium text-gray-900">Período de trabalho</label>
        <input type="text" id="periodo_trabalho" name="periodo_trabalho" value="Segunda a Sexta, 9h às 17h" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
    </div>

    <div>
        <label for="crm" class="block mb-2 text-sm font-medium text-gray-900">CRM (Código de Registro Médico)</label>
        <input type="text" id="crm" name="crm" value="1234567" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"  >
    </div>
